...
// Client credentials should be set via GOOGLE_OAUTH_CLIENT_ID and GOOGLE_OAUTH_CLIENT_SECRET (base64-encoded).
func GoogleAntigravityOAuthConfig() OAuthProviderConfig {
	clientID := os.Getenv("GOOGLE_OAUTH_CLIENT_ID")
	clientSecret := os.Getenv("GOOGLE_OAUTH_CLIENT_SECRET")
	if clientID == "" {
		clientID = decodeBase64("<SET_GOOGLE_OAUTH_CLIENT_ID_BASE64>")
	}
	if clientSecret == "" {
		clientSecret = decodeBase64("<SET_GOOGLE_OAUTH_CLIENT_SECRET_BASE64>")
	}
	return OAuthProviderConfig{
